...
export declare const en: {
    ...
    readonly 'total.anchor': "at {plan}: {amount}";
    ...
    readonly 'mode.effective': "As-of-time pricing";
    readonly 'mode.reprice': "Reprice everything";
    readonly 'mode.effectiveHint': "Each attempt uses the plan in force when it ran.";
    readonly 'mode.repriceHint': "Simulated comparison: every matching attempt at the selected plan.";
    ...
    readonly 'plan.effective': "Effective {from} → {to}";
    readonly 'plan.effectiveOpen': "Effective from {from}";
    readonly 'plan.unknownStart': "Rate regime start unknown · snapshot {at}";
    ...
    readonly 'reason.no-route': "no route recorded";
    readonly 'reason.not-official': "provider is not deepseek-official";
    readonly 'reason.no-plan': "no matching plan";
    readonly 'reason.inactive-plan': "no plan version in force at that time";
    ...
    readonly 'settings.mode': "Calculation mode";
    ...
    readonly 'settings.effectiveFrom': "Effective from";
    readonly 'settings.effectiveTo': "Effective to (optional)";
    ...
    readonly 'settings.aliases': "Model aliases";
    readonly 'settings.aliasesHint': "Map a model id this deployment reports onto a model a plan names, so it is priced without editing official plans.";
    readonly 'settings.aliasFrom': "Reported model id";
    readonly 'settings.aliasTo': "Priced as";
    readonly 'settings.aliasAdd': "Add alias";
    readonly 'settings.aliasTargets': "Plan models";
    ...
    readonly 'settings.unknownStart': "Leave the start empty when the rates’ start date is unknown: the plan then applies back to the beginning of the log.";
};
